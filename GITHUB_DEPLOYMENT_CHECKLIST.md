...
| `COZE_API_KEY` | `654a810c-bc85-44b1-8d21-ab53cbdf5d26` | Coze API 密钥 |
| `COZE_MODEL` | `doubao-1-5-vision-pro-32k-250115` | Coze 模型名称 |
| `COZE_API_BASE` | `https://ark.cn-beijing.volces.com/api/v3/chat/completions` | Coze API 地址 |
| `COZE_USE_MOCK` | `false` | 是否使用 Mock 数据 |
